...
R2_WB_INIT_JOINT_POS = {
    **{name: 0.0 for name in R2_WB_JOINT_NAMES},
    "left_hip_pitch_joint": -0.1,
    "left_knee_joint": 0.3,
...
THIRD_PARTY_R2_29DOF_CFG = UnitreeArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path=f"{UNITREE_MODEL_DIR}/r2_wholebody/usd/r2_wb.usd",
        activate_contact_sensors=True,
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            retain_accelerations=False,
    ...
    init_state=ArticulationCfg.InitialStateCfg(
        pos=(0.0, 0.0, 0.665),
        joint_pos=R2_WB_INIT_JOINT_POS,
        joint_vel={".*": 0.0},
    ),
